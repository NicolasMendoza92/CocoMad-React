...
export const TableUsers = ({tableUsers, user, setTableUsers, getUsers}) => {
    ...
    const findUser = async (_id) => {
        setIsLoading(true);
        const response = await axios.get(`https://cocomadbackend.onrender.com/api/users/${_id}`);
    ...
    const deleteUser = async (_id) => {
        ...
        await axios.delete(`https://cocomadbackend.onrender.com/api/users/${_id}`, { headers });
        await getUsers();
        setIsLoading(false);
    };
