...
export const TableProducts = ({tableProducts, getProducts, setTableProducts}) => {
    ...
    const findProduct = async (_id) => {
        setIsLoading(true);
        const response = await axios.get(`https://cocomadbackend.onrender.com/api/products/${_id}`);
    ...
    const deleteProduct = async (_id) => {
        ...
        await axios.delete(`https://cocomadbackend.onrender.com/api/products/${_id}`, { headers });
        await getProducts();
        setIsLoading(false);
    };
